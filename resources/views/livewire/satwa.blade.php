...
@section('content')
    ...
    <div class="container mx-auto w-screen flex flex-row px-6 mt-4 p-3">
        <div class="w-2/12 flex flex-col flex-shrink-0 flex-grow-0 mr-4">
            ...
            <strong class="text-sm mt-3 mb-1">Habitat</strong>
            <a href="#" class="mb-1 ml-2">Perairan</a>
            <a href="#" class="mb-1 ml-2">Daratan</a>
            <a href="#" class="mb-1 ml-2">Udara</a>
        </div>
        <div class="flex flex-col">
            <div class="flex text-gray-600 mb-3">
                <input type="search" name="search" autocomplete="off" placeholder="Cari Satwa Alam" class="w-full bg-white h-10 px-5 pr-10 rounded-full text-sm focus:outline-none">
                    ...
                    <div class="h-full border rounded-md">
                        <a href="{{ route('satwa_detail', ['id'=>$i]) }}">
                            ...
                            <div class="p-2 flex flex-cols">
                                <div class="w-11/12">
                                    <h1 class="font-medium">Belalang Sembah</h1>
                                    <p class="overflow-hidden text-sm">Tags : Amphibi, Daratan</p>
                                    <p class="overflow-hidden text-sm">Lokasi : Jawa Timur</p>
                                </div>
